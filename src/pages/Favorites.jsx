...
const Favorites = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] relative overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-pink-50 via-rose-50 to-red-100"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="text-center mb-8 backdrop-blur-sm bg-white/30 rounded-3xl p-6 sm:p-8 shadow-xl border border-white/20">
          <div className="flex items-center justify-between mb-4">
            <Link 
              to="/dashboard"
              className="p-2 text-gray-600 hover:text-red-600 transition-colors duration-200 backdrop-blur-sm bg-white/50 rounded-xl hover:bg-white/70"
            >
        ...
        {/* Error state */}
        {error && (
          <div className="backdrop-blur-sm bg-red-100/50 border border-red-200 rounded-2xl p-6 mb-8">
            <div className="flex items-center space-x-3">
              <div className="text-2xl">⚠️</div>
              <div>
                <h3 className="font-semibold text-red-800">Error Loading Favorites</h3>
        ...
        {!loading && !error && (
          <>
            {favorites.length > 0 ? (
              <>
                <div className="backdrop-blur-sm bg-gradient-to-r from-red-100/50 to-pink-100/50 rounded-2xl p-4 mb-8 border border-red-200/30">
                  <h3 className="font-semibold text-red-800 mb-2">📊 Your Collection</h3>
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-6">Start exploring recipes and save the ones you love!</p>
                <Link
                  to="/recipes"
